...
class JobFilter(django_filters.FilterSet):
    ...
    salary = django_filters.RangeFilter(lookup_expr='icontains',widget=forms.Select(attrs={'id':"searchname",
             'type':"radio", 'class':"form-radio text-emerald-600 border border-slate-100 dark:border-slate-800",
               'placeholde':"Search"}))
